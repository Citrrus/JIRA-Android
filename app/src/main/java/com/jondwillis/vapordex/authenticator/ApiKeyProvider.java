...
public class ApiKeyProvider {
     ...
     *
     * @return API key to be used for authorization with a {@link com.jondwillis.vapordex.core.BootstrapService}
     * instance
     * @throws AccountsException
     * @throws IOException
     */
    public String getAuthKey() throws AccountsException, IOException {
        AccountManagerFuture<Bundle> accountManagerFuture = accountManager.getAuthTokenByFeatures(Constants.Auth
