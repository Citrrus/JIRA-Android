...
import com.citrrus.jira.event.ResumeTimerEvent;
import com.citrrus.jira.event.PauseTimerEvent;
import com.citrrus.jira.event.StopTimerEvent;
import com.citrrus.jira.event.TimerPausedEvent;
import com.citrrus.jira.event.TimerService;
import com.citrrus.jira.event.TimerTickEvent;
...
public class BootstrapTimerActivity extends BootstrapActivity implements View.OnClickListener {
    ...
    /**
     * Posts a {@link com.citrrus.jira.event.ResumeTimerEvent} message to the {@link Bus}
     */
